function bold_compute_tsnr(fname_data,fname_bvecs,opt)
% =========================================================================
...
if nargin<2, help bold_compute_tsnr, return, end
...
j_disp(fname_log,['\n\n\n=========================================================================================================='])
j_disp(fname_log,['   Running: bold_compute_tsnr.m'])
j_disp(fname_log,['=========================================================================================================='])
...
% Convert .fdf or .dcm files to 1 4D .nii file


if moco_do
	% Motion correction
	j_disp(fname_log,['\nMotion correction...'])
	cmd = ['mcflirt -in ',fname_data,' -out tmp.bold_moco -sinc_final -dof 6'];
	j_disp(fname_log,['>> ',cmd]); [status result] = unix(cmd); if status, error(result); end
	j_disp(fname_log,['.. File created: tmp.bold_moco'])
	% update file name
	file_name = 'tmp.bold_moco';
end
