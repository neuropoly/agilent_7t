function matlabbatch = mri_set_matlabbatch_old_rats_glm_estimate(pathNii,N,...
    pathStat,ons,dur_eff,TR,HPF,remove_first_scan,MVT,scaling_GLM)
scans = {};
if scaling_GLM 
    scaling  = 'Scaling';
else
...
mvt_params = fullfile(pathNii,['rp_volume' gen_num_str(first_scan,3) '.txt']);
