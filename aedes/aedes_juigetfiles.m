...
if version_number>=7.06
  filetree = uitree('v0',fh,'position',[pos(1)+pos(3)+5 pos(2) 220 pos(4)]);
else
  filetree = uitree(fh,'position',[pos(1)+pos(3)+5 pos(2) 220 pos(4)]);
end
drawnow
...
pos2=get(filetree,'position');
if version_number>=7.06
  selfiletreeroot = uitreenode('v0','Selected Files','0 Files Selected','',false);
  selfiletree = uitree('v0',fh,'Root',selfiletreeroot,'position',[pos(1)+pos2(3)+pos(3)+100 pos(2) 220 pos(4)]);
else
  selfiletreeroot = uitreenode('Selected Files','0 Files Selected','',false);
  selfiletree = uitree(fh,'Root',selfiletreeroot,'position',[pos(1)+pos2(3)+pos(3)+100 pos(2) 220 pos(4)]);
end
drawnow
...
dir_tx = uicontrol('parent',fh,...
                   'position',[tmp(1)+5 tmp(2)+tmp(4) 150 13],...
                   'style','text',...
                   'string','Folders',...
                   'fontweight','bold',...
...
files_tx = uicontrol('parent',fh,...
                     'position',[tmp(1) tmp(2)+tmp(4) 150 13],...
                     'style','text',...
                     'string','Files',...
                     'fontweight','bold',...
                     'horizontalalign','left',...
