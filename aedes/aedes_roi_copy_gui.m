...
H.XRADIO = uicontrol('parent',H.DIRBTNGRP,...
                     ...
                     'style','radio',...
                     'string','X direction (slice)',...'value',1,...
                     'backgroundcolor',GD.col.mainfig);
...
H.ZRADIO = uicontrol('parent',H.DIRBTNGRP,...
                     ...
                     'position',[15 tmp(2)-20 150 15],...
                     'style','radio',...
                     'string','Z direction (row)',...'value',0,...
                     'backgroundcolor',GD.col.mainfig);
...
if size(ROI(1).voxels{1},4)>1
  ...
  set(H.DIRBTNGRP,'SelectedObject',H.XRADIO)
end
...
if isMixedType
  set([H.YRADIO,H.ZRADIO],'enable','off','value',0)
  set(H.XRADIO,'value',1)
end
